        ...
        <div className="fixed top-0 left-0 right-0 z-50">
          <Alert className="rounded-none bg-destructive text-destructive-foreground animate-pulse">
            ...
            <AlertDescription className="text-lg font-semibold flex justify-between items-center">
              ...
              <Button variant="outline" size="sm" onClick={() => { setShowWarning(false); alarmRef.current.stop(); }}>
                Dismiss
              </Button>
            </AlertDescription>
          </Alert>
          ...
          {error ? (
            ...
            <>
              ...
              <div className="flex gap-2">
                ...
                <Button variant={alarmEnabled ? 'default' : 'outline'} size="sm" onClick={() => {
                  setAlarmEnabled(prev => {
                    if (prev) alarmRef.current.stop();
                    return !prev;
                  });
                }}>
